...
<fwb-table hoverable class="[&_thead]:!bg-surface-raised [&_thead]:!text-ink-primary [&_tbody]:!bg-surface-card [&_tr]:!bg-surface-card [&_tr]:hover:!bg-surface-raised [&_tr]:!border-line-subtle [&_td]:!text-ink-primary [&_th]:!text-ink-primary">
<fwb-table-head>
...
<fwb-table-body>
    <fwb-table-row v-for="(value, key) in this.patients" :key="key">
        ...
        <fwb-table-cell v-else> <CheckCircleIcon class="size-6 text-green-400 mx-auto"/> </fwb-table-cell>
        <fwb-table-cell>
